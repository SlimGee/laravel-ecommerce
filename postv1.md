                ...
                <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                    <article class="card bg-dark border-0">
                        ...
                        <div class="card-img-overlay">
                            ...
                            <a href="{{ route('products.index', ['category.name' => $category->name]) }}"
...
If the product doesn't have any images we return a collection of the default image else we return the images
